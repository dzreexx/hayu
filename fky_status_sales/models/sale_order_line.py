...
class SaleOrderLine(models.Model):
    ...
    def _compute_quantities(self):
        ...
        for line in self:
            ...
            # Subtract quantities already present in this order for this product
            ...
            # For a new unsaved line, also subtract its current input quantity
            current_line_qty = line.product_uom_qty if not line.id else 0
            
            # Final available for UI: warehouse available minus order consumption
